...
function GraphTabContent({
  ...
  // Fetch workflow graph manifest only when this tab is mounted (uses project context internally)
  const {
...
export function RunDetailView({
  ...
  const { currentProject, getEnvMap } = useProject();
  ...
  const isLocalBackend = isLocalWorld(currentProject?.worldId);
